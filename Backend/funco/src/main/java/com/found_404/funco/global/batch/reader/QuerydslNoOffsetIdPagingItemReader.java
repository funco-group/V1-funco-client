package com.found_404.funco.global.batch.reader;
...
import com.found_404.funco.global.batch.reader.options.QuerydslNoOffsetNumberOptions;
...
public class QuerydslNoOffsetIdPagingItemReader<T, N extends Number & Comparable<?>>
	extends QuerydslPagingItemReader<T> {
